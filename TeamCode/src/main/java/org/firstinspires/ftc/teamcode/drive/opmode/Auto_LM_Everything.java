...
public class Auto_LM_Everything extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-45.5, -61.625, Math.toRadians(90));
        ...
        if (opModeIsActive()){
            ...
            TrajectorySequence traj3 = drive.trajectorySequenceBuilder(traj2.end())
                ...
                .lineToLinearHeading(new Pose2d(-28, -30.5, Math.toRadians(220.59)))
                ...
                //go to warehouse to collect freight
                .lineToLinearHeading(new Pose2d(-6, -46, Math.toRadians(0)))
                .lineToConstantHeading(new Vector2d(-6, -58))
                .addDisplacementMarker(() -> {
                    intake.setPower(0.8);
                })
                ...
                .lineToConstantHeading(new Vector2d(-6, -46))
                .UNSTABLE_addTemporalMarkerOffset(0.3, () -> {
                    intake.setPower(0);
                })
                .lineToLinearHeading(new Pose2d(-14.3, -29.5, Math.toRadians(276.2)))
                .build();
